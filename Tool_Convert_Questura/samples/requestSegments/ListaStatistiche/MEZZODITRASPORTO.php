...
file_put_contents( '../../xml/requestSegments_ListaStatistiche_MEZZODITRASPORTO.xml', $xml ); // log data

// init client and send data to service
$rest_cli = new REST\Client();
$rest_cli->setLogFile( __DIR__ . '/../../logs/requestSegments_ListaStatistiche_MEZZODITRASPORTO.txt' );
