...
file_put_contents( '../../xml/requestSegments_ListaResidenze_COMUNI.xml', $xml ); // log data

// init client and send data to service
$rest_cli = new REST\Client();
$rest_cli->setLogFile( __DIR__ . '/../../logs/requestSegments_ListaResidenze_COMUNI.txt' );
